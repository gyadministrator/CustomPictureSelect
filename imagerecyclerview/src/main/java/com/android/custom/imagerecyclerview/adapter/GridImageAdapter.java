package com.android.custom.imagerecyclerview.adapter;
...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, boolean isShowDelete) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        //少于8张，显示继续添加的图标
        if (getItemViewType(position) == TYPE_CAMERA && isShowDelete) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                ...
                Picasso.get().load(path).placeholder(R.color.color_f6).error(R.color.color_f6).into(viewHolder.mImg);
            }
            //itemView 的点击事件
